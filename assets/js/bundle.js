...
exports.Edge = void 0;
var d3 = _interopRequireWildcard(require("./d3.js"));
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } //jshint: "esversion": 8
...
},{"./DynamicVariable.js":1,"./constants.js":10,"./d3.js":11}],3:[function(require,module,exports){
"use strict";
  ...
  _createClass(Level, [{
    ...
    value: function animatecallback() {
      ...
      if (this.gradientdescentactive) {
        for (var k = 0; k < 10; k++) this.network.gradientstep(this.trainXs, this.trainYs, 0.001);
      }
      this.updateUI();
    }
  }, {
    ...
    value: function updatetable() {
      ...
      var errorcolor = d3.scaleSequential().domain([1, 0]).interpolator(d3.interpolateRdYlGn);
...
},{"./levels.js":12,"d3":"d3"}],6:[function(require,module,exports){
"use strict";
...
var Network = /*#__PURE__*/function () {
  ...
  _createClass(Network, [{
    ...
    value: function sqerror(trainX, trainY) {
      ...
      var sqsum = 0;
      for (var k in predicted) sqsum += (predicted[k] - trainY[k]) * (predicted[k] - trainY[k]);
      return sqsum;
    }
  }, {
    key: "loss",
    ...
    value: function gradientLoss(trainXs, trainYs) {
      ...
      var _loop2 = function _loop2() {
        ...
        for (var _i3 in predicted) sqsum += (predicted[_i3] - target[_i3]) * (predicted[_i3] - target[_i3]);
  ...
  _createClass(NetworkVisualization, [{
    ...
    value: function animateloop() {
      ...
      d3.select("#nodes").select(".target").selectAll("text").data(outputnodes.filter(function (n) {
        ...
        return "target: " + n.format(n.target);
      }).attr("x", function (n) {
      ...
      d3.select("#nodes").select(".values").selectAll("text").data(this.network.nodes).join("text").attr("font-size", 40).attr("text-anchor", "middle").attr("alignment-baseline", "hanging").attr("pointer-events", "none")
      //.attr("opacity", 0.8)
      .text(function (n) {
    ...
    value: function addInteraction() {
      ...
      var nodedrag = d3.drag().on("start", function () {
        ...
        var node = d3.select(this).data()[0];
        if (node.adjustable) {
          node.bias = clamp(this.v0 - (d3.event.y - this.y0) / _constants.unit, -4, 4);
      ...
      var edgedrag = d3.drag().on("start", function () {
        ...
        if (edge.adjustable) {
          ...
          if (Math.abs(sactivation) < _constants.parameterths) sactivation = (edge.from.getActivation() < 0 ? -1 : 1) * _constants.parameterths;
...
},{"./DynamicVariable.js":1,"./constants.js":10,"./d3.js":11}],8:[function(require,module,exports){
"use strict";
...
},{"./DynamicVariable.js":1,"./Node.js":8,"./d3.js":11}],10:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.unit = exports.parameterths = exports.noderadius = void 0;
var unit = 35;
exports.unit = unit;
...
(function (global, factory) {
  ...
  var threshold = function threshold(array, p, f) {
    if (f == null) f = number;
  ...
  var logNormal = function logNormal() {
    var randomNormal = normal.apply(this, arguments);
    return function () {
      return Math.exp(randomNormal());
    };
  };
  var irwinHall = function irwinHall(n) {
    return function () {
      for (var sum = 0, i = 0; i < n; ++i) sum += Math.random();
      return sum;
    };
  };
  var bates = function bates(n) {
    var randomIrwinHall = irwinHall(n);
    return function () {
      return randomIrwinHall() / n;
    };
  };
  var exponential = function exponential(lambda) {
    return function () {
  ...
  var length$1 = function length$1(polygon) {
    var i = -1,
      n = polygon.length,
      b = polygon[n - 1],
      xa,
  ...
  var ascending$1 = function ascending$1(series) {
  ...
  var basis$2 = function basis$2(values) {
  ...
  var basisClosed$1 = function basisClosed$1(values) {
    var n = values.length;
    return function (t) {
  ...
  var point$5 = function point$5(node, event) {
  ...
  var selector = function selector(_selector) {
    return _selector == null ? none$2 : function () {
  ...
  var window = function window(node) {
  ...
  var touches = function touches(node, _touches) {
    ...
    for (var i = 0, n = _touches ? _touches.length : 0, points = new Array(n); i < n; ++i) {
      points[i] = point$5(node, _touches[i]);
    }
    return points;
  };
  ...
  var centroid$1 = function centroid$1(object) {
  ...
  var constant$13 = function constant$13(x) {
    return function () {
      return x;
    };
  };
  ...
  var circle$1 = function circle$1() {
  ...
  var length$2 = function length$2(object) {
    lengthSum.reset();
  ...
  var graticule = function graticule() {
    var x1,
      x0,
      X1,
      X0,
  ...
  var interpolate$2 = function interpolate$2(a, b) {
    var x0 = a[0] * radians,
      y0 = a[1] * radians,
      x1 = b[0] * radians,
      y1 = b[1] * radians,
  ...
  var identity$7 = function identity$7(x) {
    return x;
  };
  var areaSum$1 = adder();
  ...
  var transform$1 = function transform$1(prototype) {
    return {
...
exports.XorLevel = exports.WeatherLevel = exports.TutorialLevelC = exports.TutorialLevelB = exports.TutorialLevelA = exports.SumLevel = exports.MaxLevel = exports.FahrenheitLevel = exports.AvgLevel = exports.AndLevel = void 0;
var d3 = _interopRequireWildcard(require("d3"));
...
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
function _isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } //jshint: "esversion": 8
...
var TutorialLevelA = /*#__PURE__*/function (_Level) {
  ...
  function TutorialLevelA() {
    ...
    _this = _super.call(this, "A simple Network: Double its input!", new _Network.Network(nodes, [nodes[0]],
    //input nodes
    ...
    _this.onenter = function () {
      ...
      d3.select("#levelinfo").append("text").text("Adjust the multiplication factor along the connection.").attr("pointer-events", "none").attr("text-anchor", "middle").attr("font-size", 20).attr("x", (nodes[0].x + nodes[1].x) / 2).attr("y", (nodes[0].y + nodes[1].y) / 2 - 100);
  ...
  return _createClass(TutorialLevelA);
}(_Level11.Level);
...
var TutorialLevelB = /*#__PURE__*/function (_Level2) {
  ...
  function TutorialLevelB() {
    ...
    var trainYs = trainXs.map(f);
    _this2 = _super2.call(this, "Propagate only positive values!", new _Network.Network(nodes, [nodes[0]],
    //input nodes
  ...
  return _createClass(TutorialLevelB);
}(_Level11.Level);
...
var TutorialLevelC = /*#__PURE__*/function (_Level3) {
  ...
  function TutorialLevelC() {
    ...
    var trainXs = [-2, -1, 0, 1, 2, 3];
    var trainYs = trainXs.map(f);
    _this3 = _super3.call(this, "Internal nodes with bias", new _Network.Network(nodes, [nodes[0]],
    //input nodes
    [nodes[2]] //output nodes
    ), ["input"], trainXs.map(function (x) {
      return [x];
  ...
  return _createClass(TutorialLevelC);
}(_Level11.Level);
...
var WeatherLevel = /*#__PURE__*/function (_Level4) {
  ...
  function WeatherLevel() {
    ...
    var nw = new _Network.Network(nodes, [nodes[0], nodes[1]],
    //input nodes
    ...
    _this4 = _super4.call(this, "Can you predict the temperature given the cloudiness and the fact of being inside?", nw, ["cloudiness", "inside?"], trainingdata.map(function (td) {
      return [td.cloudiness, td.inside];
    }), ["temperature"], trainingdata.map(function (td) {
    ...
    _this4.onenter = function () {
      addnodeinfo(nodes[0], "amount of clouds", -_constants.noderadius - 20);
      addnodeinfo(nodes[1], "inside/outside");
      addnodeinfo(nodes[4], "predicted temperature");
    };
    return _this4;
  }
  return _createClass(WeatherLevel);
}(_Level11.Level);
...
var FahrenheitLevel = /*#__PURE__*/function (_Level5) {
  ...
  function FahrenheitLevel() {
    ...
    _this5 = _super5.call(this, "Convert Celsius to Fahrenheit.", new _Network.Network(nodes, [nodes[0]],
    //input nodes
    [nodes[2]] //output nodes
  ...
  return _createClass(FahrenheitLevel);
}(_Level11.Level);
...
var SumLevel = /*#__PURE__*/function (_Level6) {
  ...
  function SumLevel() {
    ...
    _this6 = _super6.call(this, "The sum of the input activations.", new _Network.Network(nodes, [nodes[0], nodes[1]],
    //input nodes
    [nodes[2]] //output nodes
    ), ["summand 1", "summand 2"], trainXs,
    //temperatures are internally divided by 10.
    ["sum"], trainYs, "Adjust the parameters of the network such that the output on the right equals the sum of the two inputs. The predictions of the network should be correct for all the values in the training table below.");
    _this6.animatestep = function () {
      nodes[2].target = nodes[0].getActivation() + nodes[1].getActivation();
    };
    return _this6;
  }
  return _createClass(SumLevel);
}(_Level11.Level);
...
var AndLevel = /*#__PURE__*/function (_Level7) {
  ...
  function AndLevel() {
    ...
    _this7 = _super7.call(this, "Are both inputs set to 1?", nw, ["bit 1", "bit 2"], trainXs,
    //temperatures are internally divided by 10.
    ["AND"], trainYs, "The inputs of this network are either 0 or 1. The output on the right should be 1 only if both inputs are 1. Otherwise, it should be 0.");
...
var MaxLevel = /*#__PURE__*/function (_Level8) {
  ...
  function MaxLevel() {
    ...
    _this8 = _super8.call(this, "Compute the maximum of the input activations.", nw, ["input 1", "input 2"], trainXs,
    //temperatures are internally divided by 10.
    ["maximum"], trainYs, "The output on the right should be the maximum of the input. Hint: max(a, b) = max(0, a-b) + b. Remember that the internal node ignores its input if it is negative.");
    _this8.animatestep = function () {
      nodes[3].target = Math.max(nodes[0].getActivation(), nodes[1].getActivation());
    };
    return _this8;
  }
  return _createClass(MaxLevel);
}(_Level11.Level);
...
var XorLevel = /*#__PURE__*/function (_Level9) {
  ...
  function XorLevel() {
    ...
    var trainXs = [[0, 0], [1, 0], [0, 1], [1, 1]];
    var trainYs = [[0], [1], [1], [0]];
    _this9 = _super9.call(this, "Compute the XOR of the input bits.", nw, ["bit 1", "bit 2"], trainXs,
    //temperatures are internally divided by 10.
    ["XOR"], trainYs, "Assume that the network only takes 0 and 1 as input. The output of the network should be 1 if exactly one input is set to 1. Otherwise (both inputs equal) the output should be 0.");
...
var AvgLevel = /*#__PURE__*/function (_Level10) {
  ...
  function AvgLevel() {
    ...
    var nw = new _Network.Network(nodes, [nodes[0], nodes[1], nodes[2]],
    //input nodes
    [nodes[3]] //output nodes
    );
    ...
    _this10 = _super10.call(this, "The average of the input values.", nw, ["number 1", "number 2", "number 3"], trainXs,
    //temperatures are internally divided by 10.
    ["average"], trainYs, "Given three inputs, can you adjust the weights such that the output always equals to the average of the input activations? In particular, the network should produce correct outputs for all values in the table below.");
    _this10.animatestep = function () {
      nodes[3].target = (nodes[0].getActivation() + nodes[1].getActivation() + nodes[2].getActivation()) / 3;
    };
    return _this10;
  }
  return _createClass(AvgLevel);
}(_Level11.Level);
exports.AvgLevel = AvgLevel;

},{"./InputNode.js":3,"./Level.js":4,"./Network.js":6,"./Node.js":8,"./OutputNode.js":9,"./constants.js":10,"d3":"d3"}],13:[function(require,module,exports){
"use strict";
